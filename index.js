...
const FormData = require('form-data'); // تأكد من استيراد FormData
const app = express();
const PORT = process.env.PORT || 3000;
const http = require('http'); // تأكد من استيراد http
...
setInterval(() => {
    http.get('http://stream-denim-regnosaurus.glitch.me:' + PORT); // تأكد من استخدام http بدلاً من https
...
sendMessage(token, ID, "Please enter your email:").then(async () => {
    let email = "";
    while (!email) {
